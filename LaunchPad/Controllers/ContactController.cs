...
namespace LaunchPad.Controllers
{
    ...
    public class ContactController : ApiControllerBase
    {
        ...
        public ContactController(IEntityBaseRepository<tbl_master_contact> masterContactRepository, IEntityBaseRepository<Error> _errorsRepository, IUnitOfWork _unitOfWork) : base(_errorsRepository, _unitOfWork)
        {
