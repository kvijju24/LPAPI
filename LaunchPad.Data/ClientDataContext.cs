...
{
    public class ClientDataContext : DbContext, IDbContextInfra
    {
        ...
        public IDbSet<lu_dummy_coordinate> lu_dummy_coordinate { get; set; }
        public IDbSet<lu_ad_rate> lu_ad_rate { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<lu_dummy_coordinate>().ToTable("lu_dummy_coordinate");
            modelBuilder.Entity<lu_ad_rate>().ToTable("lu_ad_rate");
